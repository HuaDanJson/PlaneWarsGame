                    ...
                    for (int i = 0; i < vcBulletPlayer.size(); i++) {
                        ...
                        for (int j = 0; j < vcEnemy.size(); j++) {
                            ...
                            if (vcEnemy.elementAt(j).isCollsionWith(blPlayer)) {
                                vcBoom.add(new Blast(bmpBoom, vcEnemy.elementAt(j).x, vcEnemy.elementAt(j).y, 7));
                                if (!soundFlag) {
                                    sp.play(soundId_long, 1f, 1f, 0, 0, 1);
                                }
                            }
                    ...
                    for (int i = 0; i < vcBulletPlayer.size(); i++) {
                        ...
                        if (boss.isCollsionWith(b)) {
                            ...
                            if (boss.hp <= 0) {
                                ...
                                //在Boss上添加三个Boss爆炸效果
                                vcBoom.add(new Blast(bmpBoosBoom, boss.x + 15, boss.y + 25, 5));
                                vcBoom.add(new Blast(bmpBoosBoom, boss.x + 35, boss.y + 40, 5));
                                vcBoom.add(new Blast(bmpBoosBoom, boss.x + 65, boss.y + 20, 5));
                            }
                        }
                    }
                }
