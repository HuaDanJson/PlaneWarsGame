...
public class Player {
    ...
    public Player(Bitmap bmpPlayer, Bitmap bmpPlayerHp) {
        ...
        x = MyView.screenW / 2 - bmpPlayer.getWidth() / 2;
        y = MyView.screenH - bmpPlayer.getHeight()/2;
    }
    ...
    public void draw(Canvas canvas, Paint paint) {
        ...
        for (int i = 0; i < playerHp; i++) {
            canvas.drawBitmap(bmpPlayerHp, i * bmpPlayerHp.getWidth(), MyView.screenH - bmpPlayerHp.getHeight(), paint);
        }
    }
    ...
    public void logic() {
        ...
        //判断屏幕X边界
        if (x + bmpPlayer.getWidth() >= MyView.screenW) {
            x = MyView.screenW - bmpPlayer.getWidth();
        } else if (x <= 0) {
            x = 0;
        }
        //判断屏幕Y边界
        if (y + bmpPlayer.getHeight() >= MyView.screenH) {
            y = MyView.screenH - bmpPlayer.getHeight();
        } else if (y <= 0) {
            y = 0;
        }
        //处理无敌状态
